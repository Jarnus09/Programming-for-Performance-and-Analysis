...
void process_entry(unsigned long long addr, std::vector<L2Cache> &l2, std::vector<L3Cache> &l3)
{
    ...
    process_entry_A(addr, l2[1], l3[1]);
}
...
int main(int argc, char *argv[])
{
    ...
    printf("L2 misses Original: %llu\n", l2[0].misses);
    printf("L3 misses Original: %llu\n", l3[0].misses);
    printf("L3 cold misses Original: %llu\n\n", l3[0].cold_misses);

    printf("L2 misses Full Assoc: %llu\n", l2[1].misses);
    printf("L3 misses Full Assoc: %llu\n\n", l3[1].misses);
}